    ...
    <footer id="colophon" class="site-footer mdl-mega-footer" role="contentinfo">
        ...
        <div class="mdl-color--black">
            <div class="site-info full footer-con text-center">
                <a href="<?php echo esc_url( __( 'http://google.com.hk/', 'material-lite' ) ); ?>" ><?php _e('I <i class="material-icons mdl-color-text--red">favorite</i> Google!', 'material-lite' ); ?></a><br/><a href="<?php echo esc_url('http://ghuwad.com'); ?>"><?php _e('Developed with <i class="material-icons mdl-color-text--red">favorite</i> by Ghuwad.com', 'material-lite'); ?></a>
            </div>
        </div>
    </footer>
</div>
